...
public class BankAccount {
                ...
                public BankAccount() {
                    ...
                    System.out.println("0 arg constructor of SUPER ClaSS called");
    }

                public BankAccount(int accountNumber, String accountHolderName, double balance) {
                    super();
                    System.out.println("3 arg constructor of SUPER ClaSS called");
                ...
                public BankAccount(int accountNumber, String accountHolderName, double balance, String accountType) {
                                super();
                                System.out.println("4 arg constructor of SUPER ClaSS called");
                                this.accountNumber = accountNumber;
                                this.accountHolderName = accountHolderName;
                                this.balance = balance;
